    ...
    <div class="contenedor-perfil">
        ...
        <div class="menu-perfil">
            <ul>
                ...
                <li><a href="perfil_pageWorkAD.php" title=""><i class="icono-perfil fas fa-grin"></i> Ayuda</a></li>
            </ul>
        </div>
        <!--Vista de usuario-->
                            ...
                            <div class="features-small-item">
                                <div class="icon">
                                    <li id="user-menu-trigger">
                                        ...
                                        <a href="#">
                                            <img src="assets/images/icon-averia.png" alt="">
                                        </a>
                                    </li>
                                </div>
                                <h5 class="features-title">Averia en ruta</h5>
                            </div>
                        </div>
                            ...
                            <div class="features-small-item">
                                <div class="icon">
                                    <li id="user-menu-trigger">
                                        <!-- Agrega el atributo data-toggle y data-target para abrir el modal -->
                                        <a href="#">
                                            <img src="assets/images/icon-emergencia.png" alt="">
                                        </a>
                                    </li>
                                </div>
                                <h5 class="features-title">Emergencia en vía</h5>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
                            ...
                            <div class="features-small-item">
                                <div class="icon">
                                    <li id="user-menu-trigger">
                                        <!-- Agrega el atributo data-toggle y data-target para abrir el modal -->
                                        <a href="#">
                                            <img src="assets/images/icon-otro.png" alt="">
                                        </a>
                                    </li>
                                </div>
                                <h5 class="features-title">Otro Reporte</h5>
                            </div>
                        </div>
                        <!-- ***** Features Small Item End ***** -->
            </div>
