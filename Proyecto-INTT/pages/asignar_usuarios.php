...
<html>
  ...
  <body class="skin-blue">
                    ...
                    <div class="col-xs-12">
                      <div class="box">
                        <div class="box-header">
                          <h3 class="box-title">Modificación y vista de roles/usuarios</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                          ...
                          <thead>
                            ...
                            <tbody>
                              ...
                              while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                echo "<td>" . obtenerRol($row['usrest']) . "</td>";
                                echo "<td>";
                                echo "<button class='btn btn-primary editar-btn' data-toggle='modal' data-target='#editarModal' data-id='{$row['id']}'>Editar</button>";
                                echo "</td>";
                                echo "<td>";
                                echo "<button class='btn btn-danger eliminar-btn' data-toggle='modal' data-target='#eliminarModal' data-id='{$row['id']}'>Eliminar</button>";
                                echo "</td>";
    ...
    <!--AJAX PARA EDITAR EL CAMPO EN BASE DE DATOS-->
    <script>
    $(document).ready(function () {
        ...
        $('.editar-btn').click(function () {
            ...
            $.ajax({
                url: 'obtener_usuario.php', // Reemplaza con el nombre de tu archivo PHP para obtener datos del vehículo
                method: 'POST',
                data: { Id: Id },
                dataType: 'json',
    ...
    <!--AJAX PARA ELIMINAR EL USUARIO EN BASE DE DATOS-->
    <!-- Agregar script para manejar la confirmación de eliminación -->
      <script>
        $(document).ready(function() {
            // Capturar el ID del usuario al hacer clic en el botón de eliminar
            $('.eliminar-btn').click(function() {
                var Id = $(this).data('id');
                
                // Asignar el ID al botón de confirmación en el modal
                $('#confirmarEliminar').data('id', Id);
            });

            // Manejar la confirmación de eliminación
            $('#confirmarEliminar').click(function() {
                // Obtener el ID del usuario desde el botón de confirmación
                var Id = $(this).data('id');

                // Realizar la solicitud AJAX para eliminar al usuario
                $.ajax({
                    type: 'POST',
                    url: 'eliminar_usuario.php', // Reemplaza con la URL de tu script PHP para eliminar usuarios
                    data: { Id: Id },
              ...
              <div class="modal-body">
                  ...
                  <form id="editarForm">
                      ...
                      <div class="form-group">
                          <label for="nuevoCampo1">Rol a Modificar</label>
                          <select class="form-control" id="nuevoCampo1" name="nuevoCampo1" required>
  ...
  <!-- Modal de confirmación para eliminar -->
    <div class="modal fade" id="eliminarModal" tabindex="-1" role="dialog" aria-labelledby="eliminarModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="eliminarModalLabel">Confirmar Eliminación</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
