  ...
  <body class="skin-blue">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Editar Página Principal</a></li>
          </ol>
        </section>
                    ...
                    <div class="col-xs-12">
                      <div class="box">
                        <div class="box-header">
                          <h3 class="box-title">Tabla de Edición: "Home" de Usuario</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover">
                          <thead>
                              <tr>
                                <th>Número de Contenido</th>
                                <th>Nombre</th>
                                <th>Descripción</th>
                              </tr>
                            </thead>
                            <tbody>
                              ...
                              while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                echo "<tr>";
                                echo "<td>{$row['conide']}</td>";
                                echo "<td>{$row['conexp']}</td>";
                                echo "<td>{$row['condes']}</td>";
                                echo "<td><button class='btn btn-primary editar-btn' data-toggle='modal' data-target='#editarModal' data-id='{$row['conide']}'>Editar</button></td>";
                                echo "</tr>";
                              }
    ...
    $(document).ready(function () {
        ...
        $('.editar-btn').click(function () {
            ...
            var conideId = $(this).data('id');

            // Realiza una petición AJAX para obtener los datos del vehículo
            $.ajax({
                url: 'obtener_contenido.php', // Reemplaza con el nombre de tu archivo PHP para obtener datos del vehículo
                method: 'POST',
                data: { conideId: conideId },
                dataType: 'json',
                success: function (data) {
                    // Rellena el formulario de edición con los datos del vehículo
                    $('#conId').val(data.conide);
                    $('#nuevoCampo1').val(data.condes);
                    // Agrega más líneas según sea necesario para otros campos
                },
                error: function () {
                    alert('Error al obtener datos del contenido del home');
                }
            });
        });
        ...
        $('#editarForm').submit(function (e) {
            ...
            $.ajax({
                ...
                error: function () {
                    alert('Error al actualizar contenido del home');
                }
            });
        });
    });
      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Editar Contenido del home</h5>
                  ...
                  <form id="editarForm">
                      ...
                      <!-- Agrega los campos que desees editar -->
                        <div class="form-group">
                            <label for="nuevoCampo1">Contenido seleccionado para modificar</label>
