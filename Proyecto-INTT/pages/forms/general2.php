      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Registro de Conductores</li>
          </ol>

          <!--Formulario para los buses-->
          <div class="row">
            <div class="content mt-5">
                <h2 class="text-center">Inscripción de Buses</h2>
                <form action="procesar_inscripcion_bus.php" method="post">
                    <div class="form-group">
                        <label for="num_chasis">Número único de chasis</label>
                    ...
                    <div class="form-group">
                        <label for="estado">Estado actual del vehículo</label>
                    ...
                    <div class="form-group">
                        <label for="estado">Modelo del vehículo</label>
                        <select class="form-control" id="modeloveh" name="modeloveh" required>
                            <option value="1">ENCAVA</option>
                            <option value="2">CHEVROLET</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="estado">Marca del vehículo</label>
                        <select class="form-control" id="marcaveh" name="marcaveh" required>
                            <option value="1">ENT 610</option>
                            <option value="2">C17 BLUE BIRD</option>
                        </select>
                    </div>
