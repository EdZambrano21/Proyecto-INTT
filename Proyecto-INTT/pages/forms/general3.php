      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#">Buses y Conductores</a></li>
            <li class="active">Registro de Solicitudes</li>
          </ol>

          <!--Formulario para los buses-->
          <div class="row">
            <div class="content mt-5">
                <h2 class="text-center">Inscripción de Solicitudes</h2>
                <form action="procesar_inscripcion_solicitud.php" method="post">
                    <div class="form-group">
                        <label for="fec_afiliacion">Fecha de Afiliación</label>
                        <input type="date" class="form-control" id="fec_afiliacion" name="fec_afiliacion" pattern="\d{4}/\d{2}/\d{2}" required>
                    </div>
                    <div class="form-group">
                        <label for="cupo_asig">Cupo Asignado</label>
                        <input type="text" class="form-control" id="cupo_asig" name="cupo_asig" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="linea_asig">Linea Asignada</label>
                        <select class="form-control" id="linea_asig" name="linea_asig" required>
                            <option value="1">Intercomunal</option>
                            <option value="2">Transporte San Cristóbal</option>
                            <option value="3">21 de mayo</option>
                            <option value="4">Romulo Gallegos</option>
                        </select>
                    </div>
