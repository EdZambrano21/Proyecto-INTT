        ...
        <section class="content-header">
          ...
          <!--Formulario para usuarios-->
            <div class="content mt-5">
                <h2 class="text-center">Inscripción de Conductores</h2>
                <form action="procesar_choferes.php" method="post">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nombres">Nombres del Conductor</label>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="correo">Correo del Conductor</label>
