...
if (!isset($_SESSION['user_id'])) {
  ...
  //Impresión de tabla
   ...
   $query = "SELECT * FROM tmaevt"; // Reemplaza 'nombre_de_tabla' con el nombre real de tu tabla
  ...
  <body class="skin-blue">
    ...
    <header class="main-header">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Tabla de Datos
            <small>Evaluaciones Técnicas</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Solicitudes y cupos</a></li>
            <li class="active">Evaluaciones Técnicas</li>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabla de Evaluaciones Técnicas</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                  <thead>
                      <tr>
                        <th>Código de evaluación técnica</th>
                    ...
                    <tbody>
                      ...
                      while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                        echo "<tr>";
                        echo "<td>{$row['evtide']}</td>";
                        echo "<td>{$row['evtfec']}</td>";
                        echo "<td>{$row['evtest']}</td>";
                        echo "<td>{$row['evtdes']}</td>";
                        echo "<td>{$row['vehcha']}</td>";
                        echo "<td><button class='btn btn-primary editar-btn' data-toggle='modal' data-target='#editarModal' data-id='{$row['evtide']}'>Editar</button></td>";
                        echo "</tr>";
                      }
    ...
    $(document).ready(function () {
        ...
        $('.editar-btn').click(function () {
            ...
            $.ajax({
                url: 'obtener_resultado.php', // Reemplaza con el nombre de tu archivo PHP para obtener datos del vehículo
                method: 'POST',
                data: { resultadoId: resultadoId },
                dataType: 'json',
                success: function (data) {
                    // Rellena el formulario de edición con los datos del vehículo
                    $('#resultadoId').val(data.evtide);
                    $('#nuevoCampo1').val(data.evtest);
                    $('#nuevoCampo2').val(data.evtdes);
              ...
              <div class="modal-body">
                  ...
                  <form id="editarForm">
                      ...
                      <div class="form-group">
                          <label for="nuevoCampo1">Estado</label>
                      ...
                      <div class="form-group">
                            <label for="nuevoCampo2">Descripción</label>
                            <input type="text" class="form-control" id="nuevoCampo2" name="nuevoCampo2" required>
                      </div>
