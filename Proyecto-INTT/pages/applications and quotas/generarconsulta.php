      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Realizar evaluacion</li>
          ...
          <div class="row">
            <div class="content mt-5">
                <h2 class="text-center">Inscripción de Consultas Técnicas</h2>
                <form action="procesar_consulta.php" method="post">
                    <div class="form-group">
                        <label for="fec_realizacion">Fecha de Realización</label>
                        <input type="date" class="form-control" id="fec_realizacion" name="fec_realizacion" pattern="\d{4}/\d{2}/\d{2}" required>
                    </div>
                    <div class="form-group">
                        <label for="evt_anotacion">Anotaciones de evaluacion</label>
                        <input type="text" class="form-control" id="evt_anotacion" name="evt_anotacion" required>
                    </div>
                    <div class="form-group">
