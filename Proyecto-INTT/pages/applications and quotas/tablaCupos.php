...
if (!isset($_SESSION['user_id'])) {
  ...
  //Impresión de tabla
   ...
   $query = "SELECT * FROM tdicup"; // Reemplaza 'nombre_de_tabla' con el nombre real de tu tabla
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabla de Cupos</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
