                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li id="user-menu-trigger">
                                ...
                                <ul id="user-menu">
                                    <li><a href="perfil_pageWork.php">Perfil</a></li>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                            <div class="mini-box">
                                ...
                                <a href="ruta1work.php"><strong>Intercomunal</strong></a>
                                <span>RUTA B</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                            <div class="mini-box">
                                <i><img src="assets/images/work-process-item-01.png" alt=""></i>
                                <a href="ruta2work.php"><strong>Transporte San Cristóbal</strong></a>
                                <span>RUTA A</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                            <div class="mini-box">
                                <i><img src="assets/images/work-process-item-01.png" alt=""></i>
                                <a href="ruta3work.php"><strong>21 de Mayo</strong></a>
                                <span>RUTA A</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                            <div class="mini-box">
                                <i><img src="assets/images/work-process-item-01.png" alt=""></i>
                                <a href="ruta4work.php"><strong>Romulo Gallegos</strong></a>
                                <span>RUTA B</span>
                            </div>
                        </div>
                    </div>
