                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="ruta4.php">Romulo Gallegos</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    <div class="left-heading">
                        ...
                        <h3 class="section-title">(Línea Intercomunal)</h3>
                    </div>
                    <div class="left-text">
                        <p>Observe el recorrido que realiza esta ruta, atravesando puntos claves de la ciudad.</p>
                    </div>
                </div>
